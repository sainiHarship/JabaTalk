...
public class EmailUtils {
    ...
    public EmailUtils(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
        ...
        store.connect("smtp.gmail.com", "jabatalktestemail@gmail.com", "Test@123");
    ...
    public static boolean messagePresentValidation(String fullName) throws Exception {
        ...
        /*Code base for searching password reset link in the Email.

        Message latestMessage = emailUtils.getMessageByIndex(emailUtils.getNumberOfMessages());
        String messageContent = emailUtils.getMessageContent(latestMessage);
        System.out.println("No of unread message :"+emailUtils.getNumberOfUnreadMessages());
        System.out.println(messageContent);
        List<String> confirmemail = emailUtils.getUrlsFromMessage(latestMessage, "Confirm your account");
        for(int i=0;i<confirmemail.size();i++){
            System.out.println(confirmemail.get(i));
            System.out.println("*************************************************************");
        }*/
    return false;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        e.messagePresentValidation("harship");
    }
